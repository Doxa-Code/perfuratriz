...
export function TableComponent<T extends { id: string }>(props: Props<T>) {
  ...
  return (
    <div className="w-full">
      <div className="flex flex-wrap items-center justify-start gap-4 py-4 md:py-2">
        <Input
      ...
      <div className="space-y-4">
        <div className="overflow-auto rounded-lg h-screen max-h-[600px] border border-border bg-background">
          <Table className="table-fixed">
            <TableHeader>
              {table.getHeaderGroups().map((headerGroup) => (
                <TableRow
                  key={headerGroup.id}
                  className="hover:bg-transparent sticky top-0 bg-background"
                >
