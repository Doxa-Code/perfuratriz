const customTheme = {
  ...
  buttonGroup: {
    base: "flex items-center gap-0 transition-all duration-150 justify-start rtl:rounded",
  },
  badge: {
    root: {
      ...
      color: {
        ...
        graysubtle:
          "bg-lightemphasis dark:bg-lightgray text-link dark:text-darklink",
        white: "bg-white dark:bg-darkmuted text-dark dark:text-white",
        muted: "bg-lightgray dark:bg-darkmuted text-dark dark:text-white",
        outlinesuccess:
          "bg-transparent dark:bg-transparent border border-success dark:border-success text-success dark:text-success",
        outlineprimary:
          "bg-transparent dark:bg-transparent border border-primary dark:border-primary text-primary dark:text-primary",
      },
    },
    icon: {
  ...
  table: {
    ...
    head: {
      ...
      cell: {
        base: "font-semibold px-4 py-4  dark:bg-dark dark:text-darklink",
      },
    },
    body: {
      base: "group/body",
  ...
  navbar: {
    ...
    link: {
      base: "text-base py-1.5 px-4 hover:text-primary dark:hover:text-primary text-darklink rounded-full flex justify-center items-center cursor-pointer ",
      active: {
  ...
  sidebar: {
    root: {
      inner:
        "bg-white dark:bg-dark rounded-none w-[270px] border-r-4 border-primary dark:border-darkborder h-full",
    },
    item: {
      base: "flex items-center justify-center rounded-md px-2.5 py-2.5 mb-0.5 gap-3  !text-sm text-start  leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-darklink  dark:hover:text-primary",
      content: {
    ...
    collapse: {
      button:
        "group flex gap-3.5 items-center  rounded-md px-2.5 py-2.5 mb-0.5 text-sm text-start truncate leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-darklink w-full dark:hover:text-primary",
      icon: {
        base: "h-6 w-6 text-link text-base",
      },
      label: {
        base: "flex justify-start flex-1 max-w-36 truncate overflow-hidden leading-21",
      },
    },
    itemGroup: {
